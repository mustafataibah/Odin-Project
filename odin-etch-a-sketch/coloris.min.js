...
!(function (u, d, s, c) {
        ...
        switch (t) {
          ...
          case "parent":
            (p = d.querySelector(e.parent)) &&
              (p.appendChild(f), (S.parent = e.parent), p === d.body && (p = c));
            break;
          case "themeMode":
          ...
          case "theme":
            e.theme && (S.theme = e.theme),
              (f.className = "clr-picker clr-" + S.theme + " clr-" + S.themeMode),
              S.inline && I();
            break;
          case "rtl":
            (S.rtl = !!e.rtl),
          ...
          case "formatToggle":
            (S.formatToggle = !!e.formatToggle),
              (z("clr-format").style.display = S.formatToggle ? "block" : "none"),
          ...
          case "inline":
            (S.inline = !!e.inline),
              ...
              S.inline && ((l = e.defaultColor || S.defaultColor), (x = q(l)), I(), W(l));
            break;
          case "clearButton":
            "object" == typeof e.clearButton &&
              (e.clearButton.label &&
                ((S.clearLabel = e.clearButton.label), (g.innerHTML = S.clearLabel)),
              (e.clearButton = e.clearButton.show)),
              (S.clearButton = !!e.clearButton),
              (g.style.display = S.clearButton ? "block" : "none");
            break;
          case "clearLabel":
            (S.clearLabel = e.clearLabel), (g.innerHTML = S.clearLabel);
            break;
          case "closeButton":
            (S.closeButton = !!e.closeButton),
              S.closeButton ? f.insertBefore(m, v) : v.appendChild(m);
            break;
          case "closeLabel":
            (S.closeLabel = e.closeLabel), (m.innerHTML = S.closeLabel);
            break;
          case "a11y":
            var a,
              l,
            ...
            n &&
              ...
              m.setAttribute("aria-label", S.a11y.close),
              g.setAttribute("aria-label", S.a11y.clear),
              w.setAttribute("aria-label", S.a11y.hueSlider),
              k.setAttribute("aria-label", S.a11y.alphaSlider),
              y.setAttribute("aria-label", S.a11y.input),
    ...
    J(d, "click", e, function (e) {
      S.inline ||
        ...
        (S.focusInput || S.selectInput) &&
          ...
          y.setSelectionRange(E.selectionStart, E.selectionEnd)),
        S.selectInput && y.select(),
        (n || S.swatchesOnly) && $().shift().focus(),
        E.dispatchEvent(new Event("open", { bubbles: !0 })));
    }),
      ...
      S.inline ||
        ...
        r
          ? ((a -= s.x),
            ...
            (l += r.scrollTop))
          : (a + o > d.documentElement.clientWidth && ((a += t.width - o), (i.left = !0)),
  ...
  function R(e) {
    ...
    E &&
      ...
      e &&
        ((E = c),
        a !== t.value &&
          ((t.value = a), t.dispatchEvent(new Event("input", { bubbles: !0 })))),
      setTimeout(function () {
  ...
  function W(e) {
    ...
    P(e.s, e.v),
      ...
      (i.style.left = (b.width * e.s) / 100 + "px"),
      (i.style.top = b.height - (b.height * e.v) / 100 + "px"),
      (k.value = 100 * e.a),
      (L.style.left = 100 * e.a + "%");
  }
  function q(e) {
  ...
  function F(e) {
    (e = e !== c ? e : y.value),
      E && ((E.value = e), E.dispatchEvent(new Event("input", { bubbles: !0 }))),
      S.onChange && S.onChange.call(u, e, E),
      d.dispatchEvent(
        new CustomEvent("coloris:pick", { detail: { color: e, currentEl: E } })
      );
  }
  function Y(e, t) {
    (e = {
  ...
  function G(e, t) {
    ...
    switch (
      ...
      L.nextElementSibling.offsetHeight,
      (L.nextElementSibling.style.display = ""),
      "mixed" === r ? (r = 1 === A.a ? "hex" : "rgb") : "auto" === r && (r = x),
      r)
    ) {
      case "hex":
        y.value = o;
  ...
  NodeList !== c &&
    ...
    Q(function () {
      (p = c),
        ...
        (g = z("clr-clear")),
        (m = z("clr-close")),
        (v = z("clr-color-preview")),
        (y = z("clr-color-value")),
        (w = z("clr-hue-slider")),
        (l = z("clr-hue-marker")),
        (k = z("clr-alpha-slider")),
        (L = z("clr-alpha-marker")),
        N(S.el),
        j(S.el),
        ...
        J(y, "change", function (e) {
          var t = y.value;
          (E || S.inline) && F("" === t ? t : W(t));
        }),
        J(g, "click", function (e) {
          F(""), R();
        }),
        J(m, "click", function (e) {
          F(), R();
        }),
        J(z("clr-format"), "click", ".clr-format input", function (e) {
          (x = e.target.value), G(), F();
        }),
